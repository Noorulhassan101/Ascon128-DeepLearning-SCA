...
def main():
    print("Loading Variable-Key Dataset...")
    traces_prof, pt_prof, keys_prof, labels_prof, traces_att, pt_att, keys_att, labels_att = load_dataset("../traces/variable_key.h5")
    ...
    print("Training CNN on Variable-Key Traces...")
    history = model.fit(
        X_train, y_train,
        epochs=30,
        batch_size=64,
    ...
    model.save("../models/model_variable_key.h5")
    plot_training_history(history, "Variable Key", "../results/training_curves/variable_key_curve.png")
